...
Reference Paper: https://arxiv.org/abs/1710.09829
...
class DenseCapsule(nn.Module):
    ...
    # TODO(ecstayalive@163.com): Well, i believe if i can use some notion of the Transform to reform the CapsuleNetWork, it will perform better.
